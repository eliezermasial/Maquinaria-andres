  ...
  return (
    <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
      ...
      <div className="relative mx-auto flex w-full max-w-xl items-center justify-center">
        <div
          className="relative aspect-square w-[85%] max-w-120 overflow-hidden rounded-full
            border border-white/1 bg-emerald-950/40"
        >
          <Image
            src={image}
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
            <span className="text-4xl font-bold text-yelloAccent sm:text-5xl lg:text-6xl">
              <Counter target={100} />
              %
            </span>
            <h3 className={cn(typography.h3, "mt-1 text-white/70")}>
